...
id_admin = int(os.getenv("ID_ADMIN", "1936017380"))
# =========================================================== #
...
pic_boy = os.getenv("PIC_BOY", "https://telegra.ph/file/217c925b4b5acfb553b0e.jpg")
pic_girl = os.getenv("PIC_GIRL", "https://telegra.ph/file/43673e165e70ee302ff77.jpg")
# =========================================================== #

pesan_join = os.getenv("PESAN_JOIN", "Tidak Dapat Diakses Harap Join Terlebih Dahulu")
start_msg = os.getenv("START_MSG", "Hai {mention} 🌱\n\n<b>SM Menfess Bot</b> adalah Bot Auto Post, Semua Pesan Yang Kamu Kirim Akan Masuk Ke Channel @KocakAutoBot Secara Anonymous. Untuk Bantuan Ketik /help")
